function [vars, objs, runtime] = borg(nvars, nobjs, nconstrs, objectiveFcn, NFE, epsilons, lowerBounds, upperBounds, parameters,transposed, newCond, newCheckptFilename, oldCond, oldCheckptFilename )
...
if nargout >= 3
    ...
    elseif nargin <14
        [vars, objs, runtime] = nativeborg(nvars, nobjs, nconstrs, objectiveFcn, NFE, epsilons, lowerBounds, upperBounds, parameters, transposed, newCond, newCheckptFilename);
    else
